...
public class ViewAdapter extends RecyclerView.Adapter<ViewAdapter.ViewHolder> {
    ...
    private static final String TAG = "Jerryzhu";
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        UrlRequest.Callback callback = new SimpleUrlRequestCallback(holder.mImageViewCronet,
                this.context);
        String image = ImageRepository.getImage(position);
        UrlRequest.Builder builder = cronetEngine.newUrlRequestBuilder(
                image, callback, executor);
    ...
    class SimpleUrlRequestCallback extends UrlRequest.Callback {
        ...
        SimpleUrlRequestCallback(ImageView imageView, Context context) {
            ...
            Log.e(TAG, "SimpleUrlRequestCallback: 创建");
        }

        @Override
        public void onRedirectReceived(
                UrlRequest request, UrlResponseInfo info, String newLocationUrl) {
            android.util.Log.i(TAG, "****** onRedirectReceived ******" + info.getUrl());
        ...
        public void onReadCompleted(
            ...
            android.util.Log.i(TAG, "******数据下载完成: onReadCompleted ******" + byteBuffer);
            byteBuffer.flip();
            try {
        ...
        public void onSucceeded(UrlRequest request, UrlResponseInfo info) {
            ...
            android.util.Log.i(TAG,
                    "****** Cronet Request Completed, status code is " + info.getHttpStatusCode() + "   文本: " + info.getHttpStatusText()
        ...
        public void onCanceled(UrlRequest request, UrlResponseInfo info) {
            ...
            Log.i(TAG, "onCanceled: " + request + info);
        }
    }
}
